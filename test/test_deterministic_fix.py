...
if __name__ == "__main__":
    ...
    print(f"CUDA available: {os.popen('python -c \"import torch; print(torch.cuda.is_available())\"').read().strip()}")
    print(f"Current CUBLAS_WORKSPACE_CONFIG: {os.environ.get('CUBLAS_WORKSPACE_CONFIG', 'Not set')}")
